...
function themerex_ready_actions() {
	...
	jQuery('.menu_main_responsive .menu-item-has-children > a, .menu_side_responsive .menu-item-has-children > a').prepend('<span class="open_child_menu"></span>');
	
	jQuery('.menu_main_wrap .menu_main_responsive').on('click', 'li a, li a .open_child_menu', function(e) {
		"use strict";
		var is_menu_main = jQuery(this).parents('.menu_main_nav').length > 0;
		var $a = jQuery(this).hasClass('open_child_menu') ? jQuery(this).parent() : jQuery(this);
		if ( jQuery(this).attr('href')=='#' || jQuery(this).hasClass('open_child_menu') ) {
			if ((!is_menu_main || jQuery('body').hasClass('menu_main_responsive')) && ($a.parent().hasClass('menu-item-has-children') || $a.parent().hasClass('has_children'))) {
